...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Устаревшие фразы');
	$__finalCompiled .= '
								...
								'html' => '
										...
										<div class="dataList-subRow">
											<ul class="listInline listInline--bullet">
												<li>' . 'Пользовательская версия' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['outdated']['phrase']['version_string']) . '</li>
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . 'Устаревшие фразы отсутствуют.' . '</div>
';
	}
