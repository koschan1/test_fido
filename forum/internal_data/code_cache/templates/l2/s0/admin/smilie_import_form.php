		...
		$__finalCompiled .= '
			<h3 class="block-formSectionHeader">
				<span class="collapseTrigger collapseTrigger--block" data-xf-click="toggle" data-target=".js-importSmilie' . $__templater->escape($__vars['i']) . 'Advanced">
					<span class="block-formSectionHeader-aligner">' . 'Дополнительные параметры' . '</span>
				</span>
			</h3>
		';
	}
...
<strong>Примечание: данная настройка не будет иметь никакого эффекта, если включён режим спрайта.',
	...
	if ($__vars['uploadMode']) {
		$__finalCompiled .= '
			...
			'label' => '
						' . 'Включить режим CSS-спрайта со следующими параметрами:' . '
					',
			'_type' => 'option',
		)), array(
			'label' => 'Режим спрайта',
	...
	$__finalCompiled .= $__templater->formSelectRow(array(
		...
		'label' => '
					' . 'Показывать этот смайл в текстовом редакторе' . '
				',
		'_type' => 'option',
	)), array(
	)) . '
