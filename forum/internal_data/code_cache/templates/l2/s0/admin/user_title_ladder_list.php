...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Иерархия званий пользователей');
	$__finalCompiled .= '
...
';
	...
	array(
		...
		'_type' => 'cell',
		'html' => 'Новое' . $__vars['xf']['language']['label_separator'],
	),
	array(
		'_type' => 'cell',
		'html' => '
	...
	array(
		...
		'_type' => 'option',
			...
			<span class="block-footer-controls">' . $__templater->button('Обновить звания пользователей', array(
		'type' => 'submit',
	), '', array(
	)) . '</span>
		</div>
