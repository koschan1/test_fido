...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['entry'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Добавить задание планировщика');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Редактировать задание планировщика' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['entry']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
...
' . $__templater->form('
	...
	<div class="block-container">
		...
		'value' => 'dom',
		'label' => 'День месяца' . $__vars['xf']['language']['label_separator'],
	...
	array(
		...
		'label' => 'Запуск в часы',
		'explain' => 'Время выполнения зависит от часового пояса UTC.',
	)) . '
	...
	array(
		...
		'hint' => (($__vars['xf']['development'] AND $__vars['entry']['addon_id']) ? 'Значение этого поля не будет изменено при обновлении плагина.' : ''),
		'label' => '
					' . 'Разрешить выполнение этого задания' . '
				',
		'_type' => 'option',
	)), array(
	)) . '
