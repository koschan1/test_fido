...
' . $__templater->form('
	<div class="block-container">
		...
		'label' => 'Заголовок',
		'hint' => 'Не обязательно',
		'explain' => 'Вы можете ввести конкретное название для этого раздела. Если Вы его не введете, то будет использовано наиболее подходящее название.',
	)) . '
		...
		'label' => 'Отображение общего количества в сводке',
		'_type' => 'option',
	)), array(
		'explain' => 'Если включено, общее количество элементов, найденных в этом разделе, будет отображаться в верхней части письма со сводкой активности.',
	)) . '
