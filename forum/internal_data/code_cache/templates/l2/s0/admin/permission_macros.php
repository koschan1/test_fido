<?php
// FROM HASH: 3eb09b48968f4bbb71da161d9f1baf96
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="' . $__templater->escape($__vars['class']) . '"
		...
		<div class="' . $__templater->escape($__vars['class']) . '-main js-globalPermissionQuickSet">
			' . $__templater->button('Быстрая установка', array(
		...
		<div class="' . $__templater->escape($__vars['class']) . '-opposite quickFilter">
			<input type="text" class="input js-permissionFilterInput" placeholder="' . $__templater->filter('Фильтровать' . $__vars['xf']['language']['ellipsis'], array(array('for_attr', array()),), true) . '" />
		</div>
	</div>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['permission']['permission_type'] == 'flag') {
		...
		$__compilerTemp1 .= '
			...
			'data-container' => '< li',
			'label' => 'Указанное значение' . $__vars['xf']['language']['label_separator'],
			'hiddenlabel' => 'true',
