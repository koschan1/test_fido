...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Заблокированные пользователи');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	' . $__templater->button('Заблокировать', array(
		...
		if ($__templater->isTraversable($__vars['userBans'])) {
			foreach ($__vars['userBans'] AS $__vars['userBan']) {
				...
				array(
					'href' => $__templater->func('link', array('banning/users', $__vars['userBan']['User'], ), false),
					'_type' => 'cell',
					'html' => ($__vars['userBan']['end_date'] ? $__templater->func('date', array($__vars['userBan']['end_date'], ), true) : 'Постоянно'),
				),
				array(
					'href' => $__templater->func('link', array('banning/users', $__vars['userBan']['User'], ), false),
					'_type' => 'cell',
					'html' => ($__templater->escape($__vars['userBan']['user_reason']) ?: 'Н/Д'),
				),
				array(
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . 'Пока нет ни одного заблокированного пользователя.' . '</div>
';
	}
