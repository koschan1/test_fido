<?php
// FROM HASH: 02627ce6706b457df5d4a14cf31556c4
return array(
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Сортировка навигации');
	$__finalCompiled .= '
...
', array(
		'action' => $__templater->func('link', array('navigation/sort', ), false),
		'class' => 'block',
		'ajax' => 'true',
	)) . '
