...
<div><a href="' . ($__templater->escape($__vars['providerData']['profile_link']) ?: ('https://www.facebook.com/profile.php?id=' . $__templater->escape($__vars['connectedAccounts']['facebook']))) . '" target="_blank">' . ($__templater->escape($__vars['providerData']['username']) ?: 'Посмотреть аккаунт') . '</a></div>';
