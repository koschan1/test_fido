...
';
		...
		$__finalCompiled .= '
	' . '' . $__templater->func('username_link', array($__vars['user'], false, array('defaultname' => $__vars['alert']['username'], ), ), true) . ' оставил(а) комментарий к <a ' . (('href="' . $__templater->func('link', array('profile-posts/comments', $__vars['content'], ), true)) . '" class="fauxBlockLink-blockLink"') . '> сообщению ' . $__templater->escape($__vars['content']['ProfilePost']['username']) . '</a> в Вашем профиле.' . '
';
	}
