...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['message'], 'isUnread', array($__vars['lastRead'], ))) {
		$__finalCompiled .= '
									<span class="message-newIndicator">' . 'Новое' . '</span>
								';
	}
	$__finalCompiled .= '
								';
	...
	if ($__templater->method($__vars['conversation'], 'canReply', array())) {
		...
		$__compilerTemp2 .= '
													<a href="' . $__templater->escape($__vars['quoteLink']) . '"
														...
														data-xf-click="quote"
														data-quote-href="' . $__templater->func('link', array('conversations/messages/quote', $__vars['message'], ), true) . '">' . 'Ответ' . '</a>
	...
	if ($__templater->method($__vars['message'], 'canReport', array())) {
		$__compilerTemp3 .= '
													<a href="' . $__templater->func('link', array('conversations/messages/report', $__vars['message'], ), true) . '" class="actionBar-action actionBar-action--report" data-xf-click="overlay">' . 'Жалоба' . '</a>
												';
	}
	$__compilerTemp3 .= '
