...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . '' . $__templater->escape($__vars['sender']['username']) . ' добавил(а) Вас к переписке "' . $__templater->escape($__vars['conversation']['title']) . '"' . '
</mail:subject>

' . '<p>' . $__templater->escape($__vars['sender']['username']) . ' добавил(а) Вас в личную переписку на сайте ' . (((('<a href="' . $__templater->func('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.</p>' . '
...
<tr>
	<td>
		<a href="' . $__templater->func('link', array('canonical:conversations', $__vars['conversation'], ), true) . '" class="button">' . 'Посмотреть эту переписку' . '</a>
	</td>
