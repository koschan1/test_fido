...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['userConv']['is_starred']) {
		$__compilerTemp1 .= '
						<li>
							<i class="structItem-status structItem-status--starred" aria-hidden="true" title="' . $__templater->filter('Помечено', array(array('for_attr', array()),), true) . '"></i>
							<span class="u-srOnly">' . 'Помечено' . '</span>
						</li>
					';
	}
	$__compilerTemp1 .= '
