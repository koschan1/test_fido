...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Встроенная модерация - удалить сообщения в профиле');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('Вы уверены, что хотите удалить эти ' . $__templater->escape($__vars['total']) . ' сообщений в профиле?', array(
		'rowtype' => 'confirm',
	)) . '
