...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
	';
	$__vars['explain'] = (((!$__vars['hasPassword']) AND ($__templater->func('count', array($__vars['xf']['visitor']['Profile']['connected_accounts'], ), false) == 1)) ? 'Разрыв связи со всеми внешними аккаунтами приведёт к созданию пароля для Вашей учётной записи и отправке его Вам по электронной почте: ' . $__vars['xf']['visitor']['email'] . '.' : '');
	$__finalCompiled .= '
	' . $__templater->formRow('
