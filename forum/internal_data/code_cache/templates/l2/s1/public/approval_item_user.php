...
,array(
	...
	$__compilerTemp6[] = array(
		...
		'title' => 'Отклонённые пользователи не удаляются, а переводятся в статус \'Отклонён\'. Если причина указана выше, то она будет показана такому пользователю при следующем его входе в систему.',
