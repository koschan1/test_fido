...
';
		...
		$__finalCompiled .= '
	' . '' . ($__templater->escape($__vars['user']['username']) ?: $__templater->escape($__vars['alert']['username'])) . ' прокомментировал(а) сообщение ' . $__templater->escape($__vars['content']['ProfilePost']['username']) . ' в Вашем профиле.' . '
';
	}
	$__finalCompiled .= '
