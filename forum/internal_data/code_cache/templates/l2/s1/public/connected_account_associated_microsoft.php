...
';
	...
	$__finalCompiled .= '
<div><a href="https://profile.live.com/' . $__templater->escape($__vars['connectedAccounts']['microsoft']) . '" target="_blank">' . ($__templater->escape($__vars['providerData']['username']) ?: 'Посмотреть аккаунт') . '</a></div>';
