	...
	if ($__templater->method($__vars['post'], 'isFirstPost', array())) {
		$__compilerTemp1 .= '
				' . $__templater->formInfoRow('
					<div class="blockMessage blockMessage--important"><strong>' . 'Примечание' . $__vars['xf']['language']['label_separator'] . '</strong> ' . 'Это первое сообщение темы. Его удаление приведёт к удалению всей темы.' . '</div>
				', array(
		)) . '
			';
	}
