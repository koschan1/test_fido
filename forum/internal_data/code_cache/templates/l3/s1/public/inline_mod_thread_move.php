...
';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Встроенная модерация - переместить темы');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Вы уверены, что хотите переместить эти ' . $__templater->escape($__vars['total']) . ' тем?', array(
		'rowtype' => 'confirm',
	)) . '
		...
		'label' => 'Применить префикс к выбранным темам',
		'_dependent' => array('
