...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (!$__templater->test($__vars['prefixes'], 'empty', array())) {
		...
		<div class="menu-row menu-row--separated">
			' . 'Префикс' . $__vars['xf']['language']['label_separator'] . '
			...
			'name' => 'prefix_id',
			'noneLabel' => $__vars['xf']['language']['parenthesis_open'] . 'Учитывать все' . $__vars['xf']['language']['parenthesis_close'],
		), $__vars) . '
			</div>
		</div>
	';
	...
	if ($__templater->func('count', array($__vars['allowedThreadTypes'], ), false) > 1) {
		$__compilerTemp3 .= '
		<div class="menu-row menu-row--separated">
			<label for="ctrl_thread_type">' . 'Тип темы' . $__vars['xf']['language']['label_separator'] . '</label>
			<div class="u-inputSpacer">
				';
	...
	' . '
	<div class="menu-row menu-row--separated">
		<label for="ctrl_started_by">' . 'Автор' . $__vars['xf']['language']['label_separator'] . '</label>
		<div class="u-inputSpacer">
	...
	' . '
	<div class="menu-row menu-row--separated">
		<label for="ctrl_last_updated">' . 'Последнее обновление' . $__vars['xf']['language']['label_separator'] . '</label>
		<div class="u-inputSpacer">
			' . $__compilerTemp2 . '
	...
	' . '
	<div class="menu-row menu-row--separated">
		' . 'Упорядочить по' . $__vars['xf']['language']['label_separator'] . '
