...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Проверка IP-адреса при очистке спама');
	$__finalCompiled .= '
...
';
	...
	$__finalCompiled .= '
';
	$__templater->breadcrumb($__templater->preEscaped('Очистка спама'), $__templater->func('link', array('full:spam-cleaner', $__vars['user'], ), false), array(
	));
	$__finalCompiled .= '
