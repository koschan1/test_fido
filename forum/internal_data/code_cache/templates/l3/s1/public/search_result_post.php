...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
		...
		'defaultname' => $__vars['post']['username'],
					...
					<li>' . 'Сообщение #' . $__templater->func('number', array($__vars['post']['position'] + 1, ), true) . '' . '</li>
					<li>' . $__templater->func('date_dynamic', array($__vars['post']['post_date'], array(
	))) . '</li>
					<li>' . 'Раздел' . $__vars['xf']['language']['label_separator'] . ' <a href="' . $__templater->func('link', array('forums', $__vars['post']['Thread']['Forum'], ), true) . '">' . $__templater->escape($__vars['post']['Thread']['Forum']['title']) . '</a></li>
				</ul>
			</div>
		</div>
	</div>
