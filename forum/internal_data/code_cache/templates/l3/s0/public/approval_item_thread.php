...
' . $__templater->callMacro('approval_queue_macros', 'item_message_type', array(
		...
		'headerPhraseHtml' => 'Тема <a href="' . $__templater->func('link', array('threads', $__vars['content'], ), true) . '">' . $__templater->escape($__vars['content']['title']) . '</a> размещена в разделе <a href="' . $__templater->func('link', array('forums', $__vars['content']['Forum'], ), true) . '">' . $__templater->escape($__vars['content']['Forum']['title']) . '</a>',
	), $__vars);
