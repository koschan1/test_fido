	...
	';
		...
		<div class="block" data-widget-section="staffMembers"' . $__templater->func('widget_data', array($__vars['widget'], ), true) . '>
			<div class="block-container">
				<h3 class="block-minorHeader"><a href="' . $__templater->func('link', array('members', null, array('key' => 'staff_members', ), ), true) . '">' . 'Команда онлайн' . '</a></h3>
				<ul class="block-body">
				' . $__compilerTemp1 . '
				</ul>
			</div>
		...
		$__finalCompiled .= '
				<div class="block-row block-row--minor">
					<h4 class="block-textHeader block-textHeader--scaled">
						' . 'Пользователи, на которых я подписан(а)' . '
					</h4>
					<ul class="listHeap">
						' . $__compilerTemp2 . '
					</ul>
