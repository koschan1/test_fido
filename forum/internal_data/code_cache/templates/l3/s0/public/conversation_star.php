...
';
	...
	if ($__vars['isStarred']) {
		$__compilerTemp1 .= '
					' . 'Пожалуйста, подтвердите снятие пометки с переписки' . $__vars['xf']['language']['label_separator'] . '
				';
	} else {
		$__compilerTemp1 .= '
					' . 'Пожалуйста, подтвердите пометку переписки' . $__vars['xf']['language']['label_separator'] . '
				';
	}
