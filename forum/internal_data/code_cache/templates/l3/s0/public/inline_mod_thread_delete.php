...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Встроенная модерация - удалить темы');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('Вы уверены, что хотите удалить эти ' . $__templater->escape($__vars['total']) . ' тем?', array(
		'rowtype' => 'confirm',
	)) . '
