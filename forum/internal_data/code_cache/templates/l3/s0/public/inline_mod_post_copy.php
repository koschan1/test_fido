...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Встроенная модерация - копировать сообщения');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Вы уверены, что хотите скопировать эти ' . $__templater->escape($__vars['total']) . ' сообщений в новую тему?', array(
		'rowtype' => 'confirm',
	)) . '
