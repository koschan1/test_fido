...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Встроенная модерация - объединение сообщения');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('Вы уверены, что хотите объединить эти ' . $__templater->escape($__vars['total']) . ' сообщений?', array(
		'rowtype' => 'confirm',
	)) . '
