...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Встроенная модерация - изменить тип темы');
	$__finalCompiled .= '
	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				<div>' . 'Вы уверены, что хотите изменить тип темы для ' . $__templater->escape($__vars['total']) . ' тем?' . '</div>
