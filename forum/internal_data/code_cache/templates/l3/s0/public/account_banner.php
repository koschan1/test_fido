...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Обложка профиля');
	$__finalCompiled .= '
	...
	<div class="block-container">
		...
		'class' => 'js-bannerPosY',
				...
				<div class="profileBannerContainer-explain">
					' . 'Перетаскивайте изображение, чтобы изменить фокусную точку обложки, а затем нажмите кнопку ОК для подтверждения.' . '
				</div>
			', array(
		'rowtype' => 'noPadding',
