	...
	if ($__vars['canViewAttachments']) {
		...
		if (!$__templater->func('page_param', array('hasLb', ), false)) {
			...
			<script class="js-extraPhrases" type="application/json">
			{
				...
				"lightbox_next": "' . $__templater->filter('Следующая', array(array('escape', array('js', )),), true) . '",
				"lightbox_previous": "' . $__templater->filter('Предыдущая', array(array('escape', array('js', )),), true) . '",
				"lightbox_error": "' . $__templater->filter('Запрошенный контент не может быть загружен. Пожалуйста, попробуйте позже.', array(array('escape', array('js', )),), true) . '",
				"lightbox_start_slideshow": "' . $__templater->filter('Запустить слайд-шоу', array(array('escape', array('js', )),), true) . '",
				...
				"lightbox_toggle_sidebar": "' . $__templater->filter('Переключить боковую панель', array(array('escape', array('js', )),), true) . '"
			}
			</script>
		';
		}
