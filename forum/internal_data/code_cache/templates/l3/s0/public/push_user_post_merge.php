...
{
	$__finalCompiled = '';
	$__finalCompiled .= 'Ваши сообщения в теме ' . ($__templater->func('prefix', array('thread', $__vars['extra']['prefix_id'], ), true) . $__templater->escape($__vars['extra']['title'])) . ' были объединены.' . '
';
