...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Встроенная модерация - переместить сообщения');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Вы уверены, что хотите переместить эти ' . $__templater->escape($__vars['total']) . ' сообщений в новую тему?', array(
		'rowtype' => 'confirm',
	)) . '
		...
		'label' => 'Новая тема',
		'_dependent' => array('
						<label>' . 'Раздел назначения' . $__vars['xf']['language']['label_separator'] . '</label>
		...
		'class' => 'js-nodeList',
					...
					', '
						<label>' . 'Заголовок новой темы' . $__vars['xf']['language']['label_separator'] . '</label>
	...
	array(
		...
		'_dependent' => array('
						<label>' . 'Ссылка на тему' . $__vars['xf']['language']['label_separator'] . '</label>
