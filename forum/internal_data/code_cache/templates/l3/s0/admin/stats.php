...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Статистика');
	$__finalCompiled .= '
	...
	if ($__vars['grouping'] != 'daily') {
		$__finalCompiled .= '
				<div class="block-row block-row--minor">
					' . 'Значения представляют собой среднесуточные значения за каждый период времени.' . '
				</div>
			';
	}
	$__finalCompiled .= '
...
';
	...
	array(
		...
		'label' => 'Отображать статистику для',
	)) . '
		</div>
