...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Запись журнала действий администратора');
	$__finalCompiled .= '
	...
	<div class="block-container">
		<div class="block-body block-row">
			...
			<ul class="listInline listInline--bullet u-muted">
				<li>' . 'Сгенерировано пользователем' . $__vars['xf']['language']['label_separator'] . ' ' . ($__vars['entry']['User'] ? (((('<a href="' . $__templater->func('link', array('users/edit', $__vars['entry'], ), true)) . '">') . $__templater->escape($__vars['entry']['User']['username'])) . '</a>') : 'Неизвестная учётная запись') . '</li>
