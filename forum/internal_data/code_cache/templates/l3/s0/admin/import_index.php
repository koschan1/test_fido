...
';
	...
	<div class="blockMessage blockMessage--important">
		' . 'Импортёры теперь устанавливаются, как отдельный плагин. Вы можете скачать его в <a href="https://xenforo.com/customers" target="_blank">клиентской области</a> XenForo.' . '
	</div>
';
	}
	$__finalCompiled .= '
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . 'Нет ни одного импортёра.' . '</div>
';
	}
