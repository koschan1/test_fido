	...
	if (!$__vars['errors']) {
		...
		if ($__vars['warnings']) {
			...
			<div class="block-body">
				...
				'label' => 'Я видел предупреждения и всё ещё хочу продолжить',
				'_type' => 'option',
			)), array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['errors']) {
		...
		<div class="block-rowMessage block-rowMessage--error block-rowMessage--iconic">
			' . 'Следующие ошибки должны быть устранены до продолжения' . $__vars['xf']['language']['label_separator'] . '
			<ul>
				';
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['warnings']) {
		...
		<div class="block-rowMessage block-rowMessage--warning block-rowMessage--iconic">
			' . 'Чтобы избежать возможных проблем, пожалуйста, устраните следующие предупреждения перед продолжением' . $__vars['xf']['language']['label_separator'] . '
			<ul>
				';
