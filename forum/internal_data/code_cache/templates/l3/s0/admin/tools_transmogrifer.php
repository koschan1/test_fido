...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Управление сбросом трансмогрификаций');
	$__finalCompiled .= '
	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				' . 'Вы <em>уверены</em>, что хотите выполнить сброс трансмогрификации?' . '
				<div class="transmogrifier">
					<div>' . $__templater->button('Сброс трансмогрифера', array(
		'type' => 'submit',
		'icon' => 'confirm',
	), '', array(
	)) . '</div>
