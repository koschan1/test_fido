...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Объединить изменения в шаблоне' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['template']['title']));
	$__finalCompiled .= '
...
', )),), false), array(
				...
				$__compilerTemp1 .= trim('
								...
								<div class="diffList-resolve">
									...
									' . $__templater->button('
										&uarr; ' . 'Решить, используя родительскую версию' . '
									', array(
					...
					'data-target' => '.js-diffParent, .js-diffCustom',
									...
									' . $__templater->button('
										' . 'Решить, используя пользовательскую версию' . ' &darr;
									', array(
					'class' => 'js-resolveButton',
...
', )),), false), array(
	...
	<div class="block-container">
		<div class="block-body">
			...
			<div class="block-row block-row--separated">
				' . 'Вы можете нажать на обновление, чтобы изменить его.' . '
			</div>
		</div>
