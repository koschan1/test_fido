...
';
	...
	<div class="block-container">
		...
		'value' => 'new',
		'checked' => 'checked',
		'label' => 'Дочерний язык' . $__vars['xf']['language']['label_separator'],
	...
	array(
		...
		'html' => '<div class="formRow-explain">' . 'Перезапись языка приведёт только к замене фраз в языке. Все остальные свойства языка останутся прежними.' . '</div>',
		'_type' => 'option',
	)), array(
