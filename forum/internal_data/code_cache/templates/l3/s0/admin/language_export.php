...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Экспорт языка' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['language']['title']));
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'name' => 'untranslated',
		'label' => 'Включая неизмененные фразы',
		'hint' => 'Полезно, если Вы хотите перевести фразы, используя непосредственно XML-файл этого языка.',
		'_type' => 'option',
	)), array(
	)) . '
		</div>
