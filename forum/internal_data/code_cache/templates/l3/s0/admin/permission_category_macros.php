...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . $__templater->form('
		...
		'label' => 'Приватная категория',
		'hint' => 'Если включено, пользователям придётся напрямую давать права доступа для просмотра этой категории.',
		'_type' => 'option',
	)), array(
	)) . '
			</div>
	...
	<div class="block">
		<div class="block-container">
			<h3 class="block-header">' . 'Группы пользователей' . '</h3>
			<div class="block-body">
				';
	$__compilerTemp1 = '';
	...
	$__finalCompiled .= $__templater->form('
		<div class="block-container">
			<h3 class="block-header">' . 'Пользователи с персональными правами' . '</h3>
			<div class="block-body">
				' . $__compilerTemp2 . '
		...
		'label' => 'Установить отдельные права для пользователя',
	)) . '
			</div>
			' . $__templater->formSubmitRow(array(
