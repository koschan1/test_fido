...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<li class="nestable-item" data-id="' . $__templater->escape($__vars['node']['id']) . '">
		<div class="nestable-handle" aria-label="' . $__templater->filter('Перетаскивание', array(array('for_attr', array()),), true) . '">' . $__templater->callMacro(null, 'node_list::node_icon', array(
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Сортировать узлы');
	$__finalCompiled .= '
