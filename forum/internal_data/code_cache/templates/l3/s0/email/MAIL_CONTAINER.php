...
' . $__templater->filter($__vars['html'], array(array('raw', array()),), true) . '
		...
		<tr>
			<td class="footer" align="center" valign="top">
				<div>' . '<a href="' . $__templater->func('link', array('canonical:index', ), true) . '">Перейти на ' . $__templater->escape($__vars['xf']['options']['boardTitle']) . '</a>' . '</div>
...
' . 'Перейти на ' . $__templater->escape($__vars['xf']['options']['boardTitle']) . ': ' . $__templater->func('link', array('canonical:index', ), true) . '' . '
