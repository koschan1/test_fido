...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
		...
		';
			...
			' . $__templater->escape($__vars['thread']['username']) . ' &middot; ' . $__templater->func('date_time', array($__vars['thread']['post_date'], ), true) . ' &middot; ' . 'Ответы' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->filter($__vars['thread']['reply_count'], array(array('number_short', array()),), true) . '
		');
				$__finalCompiled .= '
		';
				$__vars['footer'] = $__templater->preEscaped('
			' . 'Раздел' . $__vars['xf']['language']['label_separator'] . ' <a href="' . $__templater->func('link', array('canonical:forums', $__vars['thread']['Forum'], ), true) . '">' . $__templater->escape($__vars['thread']['Forum']['title']) . '</a>
		');
				$__finalCompiled .= '
		';
				$__vars['footerOpposite'] = $__templater->preEscaped('
			<a href="' . $__templater->func('link', array('canonical:threads', $__vars['thread'], ), true) . '" class="button button--link">' . 'Подробнее' . '</a>
		');
				$__finalCompiled .= '
