...
if( $params ){
    ...
    if( !$data["current_category"] ){
        $data["current_page"] = findOne( "uni_clients_shops_page", "clients_shops_page_alias=? and clients_shops_page_status=? and clients_shops_page_id_shop=?", [ $alias, 1, $data["shop"]["clients_shops_id"] ] );
    }
    if( !$data["current_category"] && !$data["current_page"] ) $Main->response(404);
}
