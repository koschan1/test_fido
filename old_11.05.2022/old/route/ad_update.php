      ...
      ';
       ...
       $data["price"] .= '
          ...
          <div class="row" >
            <div class="col-lg-6" >
            <div class="input-dropdown" >
               <input type="text" name="price" value="'.number_format($data["ads_price"],0,"."," ").'" '.($data["ads_price_free"] ? 'disabled=""' : '').' class="ads-create-input inputNumber" maxlength="11" > 
               '.$dropdown_currency.'
            </div>
            <div class="msg-error" data-name="price" ></div>
            </div>
...
echo $Main->tpl("ad_update.tpl", compact( 'Seo','Geo','Main','visible_footer','Ads','out_metro','out_area','route_name','Profile','CategoryBoard','getCategoryBoard','data','settings','list_period','Filters','Banners', 'ULang', 'dropdown_currency' ) );
