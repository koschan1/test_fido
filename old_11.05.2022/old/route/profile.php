...
$data["ad_list_reviews"] = $Ads->getAll( [ "navigation" => false, "page" => $_GET["page"], "query" => "ads_id_user='".$user["clients_id"]."' and ads_status!='0' and ads_status!='8' ", "sort" => "order by ads_id desc" ] );

$data["status_publication_review"] = findOne("uni_clients_reviews", "clients_reviews_from_id_user=? and clients_reviews_id_user=?", [ intval($_SESSION['profile']['id']), $user["clients_id"] ]);
