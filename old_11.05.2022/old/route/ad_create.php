...
echo $Main->tpl("ad_create.tpl", compact( 'Seo','Geo','Main','visible_footer','Ads','out_metro','out_area','route_name','Profile','CategoryBoard','getCategoryBoard','data','settings','Filters','Banners', 'ULang', 'list_period' ) );
