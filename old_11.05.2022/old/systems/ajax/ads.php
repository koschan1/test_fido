  ...
  if($_POST["action"] == "confirm_receive_goods"){
      ...
      if($getOrder){
        ...
        if( !$payments && $user ){
          ...
          $Ads->addSecurePayments( ["id_order"=>$getOrder["secure_id_order"], "amount"=>$getOrder["secure_price"], "card"=>$user["clients_bank_card"], "id_user"=>$getOrder["secure_id_user_seller"], "status_pay"=>0, "status"=>1, "amount_percent" => $Ads->secureTotalAmountPercent($getOrder["secure_price"])] );
  ...
  if($_POST["action"] == "order_cancel_deal"){
      ...
      if($getOrder){
        ...
        if( !$payments && $user ){
          ...
          $Ads->addSecurePayments( ["id_order"=>$getOrder["secure_id_order"], "amount"=>$getOrder["secure_price"], "card"=>$user["clients_bank_card"], "id_user"=>$getOrder["secure_id_user_buyer"], "status_pay"=>0, "status"=>2, "amount_percent" => $Ads->secureTotalAmountPercent($getOrder["secure_price"], false)] );
