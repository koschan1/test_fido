      ...
      <div class="widget has-shadow">
         ...
         <div class="widget-body">
             ...
             <p><strong>Файлы шаблона</strong></p>
                ...
                <?php
                    $js_array = [ "create.js", "auth.js", "user.js", "vendor.js", "blog.js", "index.js", "catalog.js", "view.js", "update.js", "shop.js", "shops.js", "promo.js" ];
            ...
            <form method="post" id="form-tpl" > 
                ...
                <?php
                  if( $arrayFiles[ $_GET["file"] ] && $_GET["type"] ){
                     ...
                     if($_GET["type"] == "file"){
                       $dir = $config["basePath"]."/templates/".str_replace('/', '', $_GET["file"]);
                     }elseif($_GET["type"] == "css"){
                       $dir = $config["basePath"]."/templates/css/".str_replace('/', '', $_GET["file"]);
                     }elseif($_GET["type"] == "js"){
                       $dir = $config["basePath"]."/templates/js/".str_replace('/', '', $_GET["file"]);
                     }  
