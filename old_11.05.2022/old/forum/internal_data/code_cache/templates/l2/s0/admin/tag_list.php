...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Теги');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	' . $__templater->button('Добавить тег', array(
...
';
	...
	<div class="block-outer">
		...
		'placeholder' => 'Тег содержит' . $__vars['xf']['language']['ellipsis'],
		'class' => 'input--inline filterBlock-input',
	)) . '
			<span>
				<span class="filterBlock-label">' . 'Сортировать по' . $__vars['xf']['language']['label_separator'] . '</span>
