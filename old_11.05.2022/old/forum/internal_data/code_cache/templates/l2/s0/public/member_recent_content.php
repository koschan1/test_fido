...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Недавний контент ' . $__templater->escape($__vars['user']['username']) . '');
	$__finalCompiled .= '
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . '' . $__templater->escape($__vars['user']['username']) . ' ещё не публиковал(а) никакого контента.' . '</div>
';
	}
