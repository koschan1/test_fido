...
';
	...
	<div class="blockMessage blockMessage--important blockMessage--iconic">
		' . 'Этот элемент навигации был изменён. Когда связанный с ним плагин будет обновлён, Ваши изменения останутся сохранёнными.' . '
	</div>
';
	}
	$__finalCompiled .= '
...
';
	...
	<div class="blockMessage blockMessage--warning">
		' . 'Пользовательские изменения для этого элемента навигации не будут изменяться при обновлении плагина.' . '
	</div>
';
	}
	$__finalCompiled .= '
