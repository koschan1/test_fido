...
';
		...
		$__compilerTemp1 .= '
			...
			'value' => '1',
									...
									<dfn class="inputChoices-explain">
										' . 'Введите email, с которым Вы зарегистрированы в сервисе Gravatar.' . '
										<div><a href="https://gravatar.com" rel="nofollow" target="_blank">' . 'Что такое Gravatar?' . '</a></div>
									</dfn>
								'),
			'_type' => 'option',
		))) . '
	...
	<div class="block-container">
		...
		'value' => '1',
		'selected' => !$__vars['xf']['visitor']['gravatar'],
		'label' => 'Использовать собственный аватар',
		'hint' => 'Перетаскивайте изображение, чтобы его обрезать, затем нажмите <i>Ок</i> для подтверждения, или загрузите новый аватар ниже.',
		'_dependent' => array('
								<label>' . 'Загрузить новый аватар' . $__vars['xf']['language']['label_separator'] . '</label>
		...
		'accept' => '.gif,.jpeg,.jpg,.jpe,.png',
								...
								<dfn class="inputChoices-explain">
									' . 'Рекомендуется использовать изображение, размер которого, как минимум, ' . 400 . 'x' . 400 . ' пикселей.' . '
								</dfn>
							'),
		'_type' => 'option',
	))) . '
