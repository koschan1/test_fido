...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Тестирование' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['provider']['title']));
	$__finalCompiled .= '
		...
		$__finalCompiled .= '
			...
			'href' => $__templater->func('link', array('connected-accounts/perform-test', $__vars['provider'], array('test' => 1, ), ), false),
				...
				' . $__templater->formInfoRow('
					' . 'Примечание: xтобы выполнить данный тест, внешняя служба должна поддерживать перенаправление на URL-адрес' . $__vars['xf']['language']['label_separator'] . '
