...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Загрузить изображения в чат');
	$__finalCompiled .= '
...
';
	...
	' . $__templater->formSubmitRow(array(
		...
		'html' => '
			' . $__templater->button('Вставить выбранные', array(
		'icon' => 'add',
		'class' => 'button--primary siropuChatDialogInsert',
	), '', array(
	)) . '
			' . $__templater->button('Удалить выбранное', array(
		'icon' => 'delete',
