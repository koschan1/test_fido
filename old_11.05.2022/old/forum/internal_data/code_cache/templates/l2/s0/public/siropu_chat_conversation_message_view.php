...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Посмотреть сообщение от ' . $__templater->escape($__vars['message']['message_username']) . '');
	$__finalCompiled .= '
';
	$__templater->pageParams['pageDescription'] = $__templater->preEscaped('<a href="' . $__templater->func('link', array('chat/conversation/view', $__vars['message']['Conversation'], ), true) . '" class="u-concealed">' . 'Приватный разговор с ' . $__templater->escape($__vars['message']['Conversation']['Contact']['username']) . '' . '</a>');
