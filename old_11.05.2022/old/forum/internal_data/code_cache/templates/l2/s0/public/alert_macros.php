			...
			<div class="contentRow-minor contentRow-minor--smaller">
				...
				<span class="u-pullRight">
					<a href="' . $__templater->func('link', array('account/alert-toggle', null, array('alert_id' => $__vars['alert']['alert_id'], ), ), true) . '"
						data-xf-init="tooltip" data-content="' . ($__templater->method($__vars['alert'], 'isUnreadInUi', array()) ? $__templater->filter('Отметить прочитанным', array(array('for_attr', array()),), true) : $__templater->filter('Отметить как непрочитанное', array(array('for_attr', array()),), true)) . '"
						data-read="' . $__templater->filter('Отметить прочитанным', array(array('for_attr', array()),), true) . '" data-unread="' . $__templater->filter('Отметить как непрочитанное', array(array('for_attr', array()),), true) . '"
