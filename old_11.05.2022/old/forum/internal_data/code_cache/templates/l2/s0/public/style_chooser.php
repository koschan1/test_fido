...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Выбор стиля');
	$__finalCompiled .= '
...
<div class="block">
	...
	if ($__vars['style']) {
		$__finalCompiled .= '
			<div class="block-body">
				' . $__templater->formInfoRow('
					' . 'Пожалуйста, подтвердите, что Вы хотите использовать следующий стиль' . $__vars['xf']['language']['label_separator'] . '
		...
		$__finalCompiled .= '
			<a href="' . $__templater->func('link', array('misc/style', null, array('style_id' => 0, '_xfRedirect' => $__vars['redirect'], 't' => $__templater->func('csrf_token', array(), false), ), ), true) . '" class="menu-linkRow menu-linkRow--alt">' . 'Использовать стиль по умолчанию' . '</a>
			<div class="block-body">
