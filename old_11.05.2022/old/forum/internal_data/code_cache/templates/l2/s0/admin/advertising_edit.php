...
';
	...
	<div class="block-container">
		...
		'label' => 'Заголовок',
		'explain' => 'Укажите короткий заголовок для этой рекламы, который будет отображаться на странице списка рекламы.',
	)) . '
	...
	array(
		...
		'explain' => 'Используйте указанные выше критерии, чтобы ограничить показ этой рекламы для определённых пользователей.',
	)) . '

			' . $__templater->callMacro('display_order_macros', 'row', array(
		'value' => $__vars['ad']['display_order'],
		'explain' => 'Введите порядок отражения относительно других рекламных материалов в этой же позиции.',
	), $__vars) . '
