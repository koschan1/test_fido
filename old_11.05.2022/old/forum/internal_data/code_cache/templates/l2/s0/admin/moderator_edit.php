...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Редактировать модератора' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['user']['username']));
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'rowid' => 'addUserGroups',
		'label' => 'Добавить модератора в группы',
		'hint' => '
					' . $__templater->formCheckBox(array(
		'standalone' => 'true',
	), array(array(
