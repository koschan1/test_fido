...
jQuery.extend(XF.phrases, {
	...
	s2_input_too_long: "' . $__templater->filter('Пожалуйста, удалите {count} символ(ов).', array(array('escape', array('js', )),), false) . '",
	...
	s2_maximum_selected: "' . $__templater->filter('Вы можете выбрать не более {count} элемена(ов).', array(array('escape', array('js', )),), false) . '",
