...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	array(
		...
		'label' => 'Пользователь отправил по крайней мере Х сообщений чата' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formNumberBox(array(
	...
	array(
		...
		'label' => 'Пользователь отправил не более Х сообщений чата' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formNumberBox(array(
