...
';
	...
	if ($__vars['displayAdvanced']) {
		$__compilerTemp4 .= '
			...
			'label' => 'Перезаписать существующие файлы плагина для перестроения/обновления',
			'hint' => 'По умолчанию из архива плагина копируются только измененные файлы. Чтобы перезаписать все существующие файлы, выберите эту опцию.',
			'_type' => 'option',
		)), array(
			'rowtype' => 'fullWidth',
		)) . '
