...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['widgetDefinition'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Добавить определение виджета');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Редактировать определение виджета' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['widgetDefinition']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
...
' . $__templater->form('
	<div class="block-container">
		...
		'label' => 'Класс определения',
		'explain' => 'Этот класс должен реализовать все соответствующие поведения виджета. Он должен быть основан на <code>\\XF\\Widget\\AbstractWidget</code>.',
	)) . '
