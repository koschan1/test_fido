				...
				$__compilerTemp2 .= '
					<div class="block-outer block-outer--after acp--simple">
						<div class="block-outer-middle block-outer-hint">
							' . '' . $__templater->filter($__vars['advancedCount'], array(array('number', array()),), true) . ' дополнительных опций было скрыто.' . '
							<a tabindex="0" role="button" data-xf-click="admin-toggle-advanced" data-value="1" data-url="' . $__templater->func('link', array('account/toggle-advanced', ), true) . '">' . 'Показать.' . '</a>
						</div>
					</div>
				';
			}
