...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Поиск');
	$__finalCompiled .= '
...
';
	...
	if ($__vars['xf']['options']['enableTagging']) {
		$__compilerTemp2 .= '
					<a href="' . $__templater->func('link', array('tags', ), true) . '" class="tabs-tab">' . 'Поиск тегов' . '</a>
				';
	}
	...
	<div class="block-container">
		<h2 class="block-tabHeader tabs hScroller" data-xf-init="h-scroller">
			<span class="hScroller-scroll">
				<a href="' . $__templater->func('link', array('search', ), true) . '" class="tabs-tab' . ((!$__vars['type']) ? ' is-active' : '') . '">' . 'Искать везде' . '</a>
				' . $__compilerTemp1 . '
				' . $__compilerTemp2 . '
			</span>
		</h2>
