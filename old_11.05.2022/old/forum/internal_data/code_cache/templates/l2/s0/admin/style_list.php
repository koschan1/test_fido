...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['xf']['designer'] AND $__vars['style']['designer_mode']) {
		$__compilerTemp1 .= '
				' . 'Режим дизайнера включён' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['style']['designer_mode']) . '
			';
	}
	...
	if ($__vars['style']['style_id']) {
		$__compilerTemp2[] = array(
			...
			'submit' => 'true',
			'tooltip' => 'Включить/отключить \'' . $__vars['style']['title'] . '\'',
			'_type' => 'toggle',
			'html' => '',
		);
		$__compilerTemp2[] = array(
	...
	if ($__vars['style']['style_id']) {
		...
		if ($__vars['canSupportStyleArchives']) {
			$__compilerTemp3 .= '
							<a href="' . $__templater->func('link', array('styles/export-archive', $__vars['style'], ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Экспорт в виде архива' . '</a>
						';
		}
		$__compilerTemp2[] = array(
			'label' => '&#8226;&#8226;&#8226;',
			...
			'html' => '
				<div class="menu" data-menu="menu" aria-hidden="true" data-menu-builder="dataList">
					<div class="menu-content">
						...
						<a href="' . $__templater->func('link', array('styles/export', $__vars['style'], ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Экспорт в виде XML' . '</a>
						' . $__compilerTemp3 . '
						<a href="' . $__templater->func('link', array('styles/customized-components', $__vars['style'], ), true) . '" class="menu-linkRow">' . 'Изменённые компоненты' . '</a>
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Стили');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	' . $__templater->button('Добавить стиль', array(
