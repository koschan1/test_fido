...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= $__templater->callMacro('approval_queue_macros', 'item_message_type', array(
		...
		'typePhraseHtml' => 'Сообщение в профиле',
		'spamDetails' => $__vars['spamDetails'],
		'unapprovedItem' => $__vars['unapprovedItem'],
		'handler' => $__vars['handler'],
		'headerPhraseHtml' => 'Размещено в профиле <a href="' . $__templater->func('link', array('profile-posts', $__vars['content'], ), true) . '">' . $__templater->escape($__vars['content']['ProfileUser']['username']) . '</a>',
	), $__vars);
