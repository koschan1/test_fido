	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				' . 'Пожалуйста, подтвердите, что Вы хотите вернуть ' . $__templater->func('count', array($__vars['templateIds'], ), true) . ' шаблонов и ' . $__templater->func('count', array($__vars['propertyIds'], ), true) . ' настроек стиля <em>' . $__templater->escape($__vars['style']['title']) . '</em> в исходное состояние.' . '
			', array(
		'rowtype' => 'confirm',
	)) . '
		</div>
