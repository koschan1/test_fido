	...
	$__finalCompiled .= $__templater->formCheckBoxRow(array(
		...
		'_dependent' => array('
			<dl class="inputLabelPair">
				<dt><label for="' . $__templater->escape($__vars['inputName']) . '_min">' . 'Начать отправлять email со сводкой активности, если пользователь неактивен в течение' . '</label></dt>
				<dd>
		...
		'id' => $__vars['inputName'] . '_min',
						...
						<span class="inputGroup-text">' . 'Дн.' . '</span>
					</div>
				</dd>
			</dl>

			<dl class="inputLabelPair">
				<dt><label for="' . $__templater->escape($__vars['inputName']) . '_freq">' . 'Отправлять email со сводкой активности неактивному пользователю каждые' . '</label></dt>
				<dd>
					<div class="inputGroup">
						' . $__templater->formNumberBox(array(
		...
		'id' => $__vars['inputName'] . '_freq',
			...
			<dl class="inputLabelPair">
				<dt><label for="' . $__templater->escape($__vars['inputName']) . '_max">' . 'Прекратить отправлять письма со сводкой активности на email, если пользователь неактивен более' . '</label></dt>
				<dd>
					<div class="inputGroup">
						' . $__templater->formNumberBox(array(
