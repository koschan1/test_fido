...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
		...
		'notfa' => 'fa-info-circle',
			...
			<div class="menu" data-menu="menu" aria-hidden="true" id="js-toolbar-menu--' . $__templater->escape($__vars['key']) . '">
				<div class="menu-content">
					<h3 class="menu-header">' . 'Параметры группы' . '</h3>

					<div class="menu-row menu-row--separated">
						' . 'Видимые кнопки' . $__vars['xf']['language']['label_separator'] . '
		...
		'data-button-smaller' => '1',
					...
					<div class="menu-row menu-row--separated">
						' . 'Выравнивание группы' . $__vars['xf']['language']['label_separator'] . '
						<div class="u-inputSpacer">
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<script class="js-extraPhrases" type="application/json">
		{
			"buttons_menus_may_not_be_duplicated": "' . $__templater->filter('Кнопки и меню не могут дублироваться.', array(array('escape', array('json', )),), true) . '",
			"button_removed": "' . $__templater->filter('Кнопка удалена', array(array('escape', array('json', )),), true) . '"
		}
	</script>
';
	return $__finalCompiled;
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Редактировать панель инструментов' . ': ' . $__templater->escape($__vars['typeTitle']));
	$__finalCompiled .= '
...
';
	...
	<div class="menu" data-menu="menu" aria-hidden="true">
		<div class="menu-content">
			<h3 class="menu-header">' . 'Панели инструментов' . '</h3>
			' . $__compilerTemp1 . '
		</div>
	</div>

	' . $__templater->button('
		' . 'Сбросить конфигурацию кнопок' . '
	', array(
	...
	<div class="block">
		<div class="block-container">
			<h2 class="block-header">
				' . 'Доступные кнопки и выпадающие меню' . '
			</h2>
			...
			<div class="block-row block-row--minor u-muted">
				' . 'Это список всех кнопок, которые можно добавить в редактор. Нижняя строка содержит доступные выпадающие меню. Перетащите нужные кнопки отсюда на панель инструментов ниже.' . '
			</div>
		</div>
	</div>
...
' . $__templater->form('
	...
	<div class="block-container">
		...
		'data-min-height' => '50',
		'data-max-height' => '100',
		'placeholder' => 'Предварительный просмотр макета Вашей кнопки' . '...',
		'data-deferred' => 'off',
		'data-xf-key' => 'r',
