...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div><a href="' . $__templater->escape($__vars['providerData']['profile_link']) . '" target="_blank">' . ($__templater->escape($__vars['providerData']['username']) ?: 'Посмотреть аккаунт') . '</a></div>
';
	} else {
		$__finalCompiled .= '
	<img src="' . ($__templater->escape($__vars['providerData']['avatar_url']) ?: 'https://avatars.githubusercontent.com/u/{$connectedAccounts.github}?v=3') . '" width="48" alt="" />
	<div>' . ($__templater->escape($__vars['providerData']['username']) ?: 'Аккаунт привязан') . '</div>
';
	}
