...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . '' . $__templater->func('username_link', array($__vars['user'], false, array('defaultname' => $__vars['newsFeed']['username'], ), ), true) . ' прокомментировал(а) сообщение в профиле ' . (((('<a href="' . $__templater->func('link', array('profile-posts/comments', $__vars['content'], ), true)) . '">') . $__templater->escape($__vars['content']['ProfilePost']['username'])) . '</a>') . '.' . '
</div>
