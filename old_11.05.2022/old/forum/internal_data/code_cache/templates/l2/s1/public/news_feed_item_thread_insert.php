...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . '' . $__templater->func('username_link', array($__vars['user'], false, array('defaultname' => $__vars['newsFeed']['username'], ), ), true) . ' создал(а) новую тему ' . ((((('<a href="' . $__templater->func('link', array('threads', $__vars['content'], ), true)) . '">') . $__templater->func('prefix', array('thread', $__vars['content'], ), true)) . $__templater->escape($__vars['content']['title'])) . '</a>') . ' в ' . (((('<a href="' . $__templater->func('link', array('forums', $__vars['content']['Forum'], ), true)) . '">') . $__templater->escape($__vars['content']['Forum']['title'])) . '</a>') . '.' . '
</div>
