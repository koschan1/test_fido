...
'before_status_watch' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['xf']['visitor']['user_id']) {
		...
		if ($__vars['voteState'] == 'up') {
			$__finalCompiled .= '
				<li>
					<i class="structItem-status structItem-status--upvoted" aria-hidden="true" title="' . $__templater->filter('За', array(array('for_attr', array()),), true) . '"></i>
					<span class="u-srOnly">' . 'За' . '</span>
				</li>
			';
		} else if ($__vars['voteState'] == 'down') {
			$__finalCompiled .= '
				<li>
					<i class="structItem-status structItem-status--downvoted" aria-hidden="true" title="' . $__templater->filter('Против', array(array('for_attr', array()),), true) . '"></i>
					<span class="u-srOnly">' . 'Против' . '</span>
				</li>
			';
		}
		$__finalCompiled .= '
