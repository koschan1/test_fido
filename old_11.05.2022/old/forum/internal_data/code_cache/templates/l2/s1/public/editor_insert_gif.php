...
<div class="menu-row menu-row--alt menu-row--close menu-row--search">
	<div class="inputGroup">
		...
		' . $__templater->button('
			<span class="u-srOnly">' . 'Закрыть' . '</span>
		', array(
		'icon' => 'close',
...
<div class="menu-footer menu-footer--close menu-footer--split">
	<div class="menu-footer-opposite">
		<a href="https://giphy.com" target="_blank"><img src="' . $__templater->func('base_url', array('styles/default/xenforo/giphy.png', ), true) . '" alt="' . $__templater->filter('Предоставляется GIPHY', array(array('for_attr', array()),), true) . '" style="width: 100px" /></a>
	</div>
</div>';
