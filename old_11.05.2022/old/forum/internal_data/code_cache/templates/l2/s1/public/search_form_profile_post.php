...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Поиск сообщений в профиле');
	$__finalCompiled .= '
...
' . $__templater->formTextBoxRow(array(
		...
		'label' => 'Написано в профиле пользователя',
		'explain' => 'Здесь можно ввести несколько имён.',
	)) . '
