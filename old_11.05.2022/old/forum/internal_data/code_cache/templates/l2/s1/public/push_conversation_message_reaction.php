...
{
	$__finalCompiled = '';
	$__finalCompiled .= '' . ($__templater->escape($__vars['user']['username']) ?: $__templater->escape($__vars['alert']['username'])) . ' отреагировал на Ваше сообщение в переписке ' . $__templater->escape($__vars['content']['Conversation']['title']) . '. Реакция: ' . $__templater->func('reaction_title', array($__vars['extra']['reaction_id'], ), true) . '' . '
