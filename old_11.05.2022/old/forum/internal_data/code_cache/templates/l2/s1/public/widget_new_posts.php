	...
	<div class="block"' . $__templater->func('widget_data', array($__vars['widget'], ), true) . '>
		...
		if ($__vars['style'] == 'full') {
			...
			if (!$__templater->test($__vars['threads'], 'empty', array())) {
				...
				$__finalCompiled .= '
							<div class="block-row">
								' . 'У Вас нет непрочитанных сообщений. Вы можете просмотреть все <a href="' . $__templater->func('link', array('whats-new/posts', null, array('skip' => 1, ), ), true) . '" rel="nofollow">последние сообщения</a>' . '
							</div>
						';
			} else {
				$__finalCompiled .= '
