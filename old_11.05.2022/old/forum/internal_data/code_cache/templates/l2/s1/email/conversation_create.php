...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . '' . $__templater->escape($__vars['sender']['username']) . ' начал(а) с Вами переписку: "' . $__templater->escape($__vars['conversation']['title']) . '"' . '
</mail:subject>

' . '<p>' . $__templater->escape($__vars['sender']['username']) . ' начал(а) с Вами новую личную переписку на сайте ' . (((('<a href="' . $__templater->func('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.</p>' . '
