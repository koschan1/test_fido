...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
		...
		<span class="siropuChatConversationActions">
			<a href="' . $__templater->func('link', array('chat/conversation/leave', $__vars['conversation'], ), true) . '" class="siropuChatLeaveConversation" title="' . $__templater->filter('Покинуть приватный разговор', array(array('for_attr', array()),), true) . '" data-xf-init="tooltip" data-xf-click="overlay">' . $__templater->fontAwesome('far fa-times-circle', array(
	)) . '</a>
			<a href="' . $__templater->func('link', array('chat/conversation/view', $__vars['conversation'], array('fullpage' => 'true', ), ), true) . '" class="siropuChatConversationPopup" data-xf-click="siropu-chat-popup" title="' . $__templater->filter('В всплывающем окне', array(array('for_attr', array()),), true) . '" data-xf-init="tooltip">' . $__templater->fontAwesome('far fa-external-link-alt', array(
	)) . '</a>
		</span>
		' . $__templater->callMacro('siropu_chat_user_macros', 'user_status', array(
		'user' => $__vars['user'],
