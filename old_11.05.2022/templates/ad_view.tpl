              ...
              <div class="col-lg-9" >
                   ...
                   <div class="row" >                    
                     ...
                     <div class="col-lg-12 col-md-12 col-sm-12 col-12" >
                       <div class="word-break art_font_12" ><?php echo nl2br($data["ad"]["ads_text"]); ?> </div>
                     </div>
                   ...
                   <div class="row" >
                      <div class="col-lg-12 col-12 mb15" > <?php echo $ULang->t( $data["ad"]["city_name"], [ "table" => "geo", "field" => "geo_name" ] ); ?>, <?php echo $ULang->t( $data["ad"]["region_name"], [ "table" => "geo", "field" => "geo_name" ] ); ?> </div> 
                   
                     <div class="col-lg-9 col-12 word-break small" >
                   ...
                   <div class="row" >
                     ...
                     <span class="span-style" ><?php echo $ULang->t("В избранном"); ?>: <?php echo $Profile->getCountFavorites($data["ad"]["ads_id"]); ?></span></div>

                     <div class="col-lg-2 col-md-3 col-sm-3 col-6" ><span class="span-style" ><?php echo $ULang->t("Просмотры"); ?>: <?php echo $Ads->getCountView($data["ad"]["ads_id"]); ?> </span></div>

                     <?php if($_SESSION["profile"]["id"] == $data["ad"]["ads_id_user"]){ ?>
                     <div class="col-lg-2 col-md-3 col-sm-3 col-6" ><span class="span-style" ><?php echo $ULang->t("Показов"); ?>: 
                     ...
                     <div class="col-lg-2 col-md-3 col-sm-3 col-6" ><span class="span-style" ><?php echo $ULang->t("Размещено"); ?>:<br/>
                     
                     <span class="small"> <?php echo datetime_format($data["ad"]["ads_datetime_add"], false); ?></span></span></div>
                     
                     <?php if($_SESSION["profile"]["id"] == $data["ad"]["ads_id_user"]){ ?>

                     <div class="col-lg-2 col-md-3 col-sm-3 col-6" ><span class="span-style" ><?php echo $ULang->t("Активно до"); ?>:<br/> 
                     <span class="small"><?php echo datetime_format($data["ad"]["ads_period_publication"], false); ?></span></span></div>

                     <?php } ?>

                     <div class="col-lg-2 col-md-3 col-sm-3 col-6" ><span class="span-style" ><?php echo $ULang->t("Поделиться"); ?>:<br/> <?php echo $data["share"]; ?></span></div>
                   ...
                   <h5 class="mb30 mt15" > <?php echo $ULang->t("Комментарии"); ?> </h5>
...
<?php if( $_GET['action'] == 'reply' && isset($_GET['id']) ): ?>
  <script type="text/javascript">
    $(document).ready(function () {
      let comment_id = "<?= $_GET['id'] ?>";
      
      $(`[data-id='${comment_id}']`).children('.module-comments-content').children('.module-comments-form-otvet').css('display', 'block');
      $(`[data-id='${comment_id}']`).children('.module-comments-content').children('.module-comments-form-otvet').children('form').children('textarea').focus();
    })
  </script>
<?php endif ?>
  </body>
