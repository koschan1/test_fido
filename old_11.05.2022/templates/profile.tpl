               ...
               <div class="user-menu-tab-content <?php if($action == "balance"){ echo 'active'; } ?>" data-id-tab="balance" >
                ...
                <div class="module-balance" >
                   ...
                   <div class="user-balance-summa" >
                        ...
                        <div>
                          <div>
                            <p><?php echo $Main->price(20000); ?></p>
                            <?php if($settings["bonus_program"]["balance"]["status"]){ ?>
                            <span>+ <?php echo $Main->price( $Profile->calcBonus(20000) ); ?> <?php echo $ULang->t("бонус"); ?></span>
                            <?php } ?>
                        ...
                        <div>
                          <div>
                             <p><?php echo $Main->price(50000); ?></p>
                             <?php if($settings["bonus_program"]["balance"]["status"]){ ?>
                             <span>+ <?php echo $Main->price( $Profile->calcBonus(50000) ); ?> <?php echo $ULang->t("бонус"); ?></span>
                             <?php } ?>    
                        ...
                        <div>
                          <div>
                             <p><?php echo $Main->price(90000); ?></p>
                             <?php if($settings["bonus_program"]["balance"]["status"]){ ?>
                             <span>+ <?php echo $Main->price( $Profile->calcBonus(90000) ); ?> <?php echo $ULang->t("бонус"); ?></span>
                             <?php } ?> 
                             <input type="radio" name="amount" value="90000" >
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div>
                             <p><?php echo $Main->price(120000); ?></p>
                             <?php if($settings["bonus_program"]["balance"]["status"]){ ?>
                             <span>+ <?php echo $Main->price( $Profile->calcBonus(120000) ); ?> <?php echo $ULang->t("бонус"); ?></span>
                             <?php } ?> 
                             <input type="radio" name="amount" value="120000" >
                          </div>
                        </div>
                                 ...
                                 <div class="col-lg-6" >
                                   <div class="profile-subscriptions-config" >
                                      ...
                                      <div class="btn-group" role="group">
                                        <button type="button" class="btn btn-light profile-subscriptions-ad-period <?php if($value["ads_subscriptions_period"] == 2){ echo 'active'; } ?> " data-period="2" data-id="<?php echo $value["ads_subscriptions_id"]; ?>" ><?php echo $ULang->t("Сразу"); ?></button>
                                        <button type="button" class="btn btn-light profile-subscriptions-ad-period <?php if($value["ads_subscriptions_period"] == 1){ echo 'active'; } ?>" data-period="1" data-id="<?php echo $value["ads_subscriptions_id"]; ?>" ><?php echo $ULang->t("Один раз в день"); ?></button>
                                        <button type="button" class="btn btn-light profile-subscriptions-ad-period <?php if($value["ads_subscriptions_period"] == 3){ echo 'active'; } ?>" data-period="3" data-id="<?php echo $value["ads_subscriptions_id"]; ?>" ><?php echo $ULang->t("Раз в 3 дня"); ?></button>
