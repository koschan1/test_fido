  ...
  <div class="form-group row d-flex align-items-center mb-5">
    ...
    <div class="col-lg-5">
         <h3 style="margin-top: 10px;" > <strong>Массовые выплаты</strong> </h3>
    </div>
  </div>

  <div class="form-group row d-flex align-items-center mb-5">
    <label class="col-lg-3 form-control-label">ID Api</label>
    <div class="col-lg-5">
         <input type="text" class="form-control" value="<?php echo $param["id_api"]; ?>"  name="payment_param[id_api]" >
    </div>
  </div>
  ...
  <div class="form-group row d-flex align-items-center mb-5">
    <label class="col-lg-3 form-control-label">Секретный ключ</label>
    <div class="col-lg-5">
         <input type="text" class="form-control" value="<?php echo $param["secret_key_masspay"]; ?>"  name="payment_param[secret_key_masspay]" >
    </div>
  </div>
