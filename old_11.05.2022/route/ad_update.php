           ...
           $price = '
                    ...
                    <div class="row" >
                      <div class="col-lg-6" >
                          <div class="input-dropdown" >
                             <input type="text" name="price" class="ads-create-input inputNumber" value="'.number_format($data["ads_price"],0,"."," ").'" maxlength="15" > 
                             '.$dropdown_currency.'
                          </div>
                ...
                <div class="ads-create-main-data-box-item" >
                    ...
                    <div class="row" >
                      <div class="col-lg-6" >
                          <div class="input-dropdown" >
                             <input type="text" name="auction_price_sell" class="ads-create-input inputNumber" value="'.number_format($data["ads_auction_price_sell"],0,"."," ").'" maxlength="15" > 
                             <div class="input-dropdown-box">
                                <div class="uni-dropdown-align" >
		           ...
		           <div class="ads-create-main-data-box-item" style="margin-top: 0px;" >
		              <div class="row" >
		                <div class="col-lg-6" >
		                    ...
		                    <div class="input-dropdown" >
		                       <input type="text" name="price" placeholder="'.$ULang->t("Старая цена").'" value="'.number_format($data["ads_price_old"],0,"."," ").'" class="ads-create-input inputNumber" maxlength="15" > 
		                       '.$dropdown_currency.'
		                    </div>
		                    <div class="msg-error" data-name="price" ></div>
		                ...
		                <div class="col-lg-6" >
		                    ...
		                    <div class="input-dropdown" >
		                       <input type="text" name="stock_price" placeholder="'.$ULang->t("Новая цена").'" value="'.number_format($data["ads_price"],0,"."," ").'" class="ads-create-input inputNumber" maxlength="15" > 
		                       <div class="input-dropdown-box">
		                          <div class="uni-dropdown-align" >
		                             <span class="input-dropdown-name-display static-currency-sign"> '.$settings["currency_data"][ $data["ads_currency"] ]["sign"].' </span>
		                          </div>
	           ...
	           $price .= '
	              ...
	              <div class="row" >
	                ...
	                <div class="col-lg-6" >
	                    ...
	                    <div class="input-dropdown" >
	                       <input type="text" name="price" '.($data["ads_price_free"] ? 'disabled=""' : '').' placeholder="'.$field_price_name.'" value="'.number_format($data["ads_price"],0,"."," ").'" class="ads-create-input inputNumber" maxlength="15" > 
	                       '.$dropdown_currency.'
	                    </div>
	                    <div class="msg-error" data-name="price" ></div>
