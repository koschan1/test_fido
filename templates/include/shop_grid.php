...
<div class="col-lg-4 col-md-4 col-sm-6 col-12" >
  ...
  <div <?php if($get_shop_slider["clients_shops_slider_image"]){ ?> style="background-image: linear-gradient(rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0.24) 75%, rgba(0, 0, 0, 0.64)), url(<?php echo $config["urlPath"] . "/" . $config["media"]["users"] . "/" . $get_shop_slider["clients_shops_slider_image"]; ?>); background-position: center center; background-size: cover;" class="shop-item-card shop-item-card-bg" <?php }else{  ?> class="shop-item-card" <?php  } ?> >
