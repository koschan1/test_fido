                  ...
                  <div class="container-search-goods parents-ajax-live-search" >
                      ...
                      <div class="header-wow-sticky-search" >
                          ...
                          <div class="sticky-search-geo-area-list" >
                              ...
                              <div class="row mt30" >
                                 <div class="col-lg-3" > <button class="btn-custom btn-color-blue width100 filter-accept" ><?php echo $ULang->t("Применить"); ?></button> </div>
                              </div>
...
<header class="header-wow-mobile d-block d-lg-none <?php if( $route_name == "catalog" || $route_name == "index" ){ echo 'height200'; }else{ echo 'height55'; } ?>" >
      ...
      <div class="container" >
         <div class="header-flex-box" >   
             ...
             <div class="header-flex-box-mobile-2" >
                  ...
                  <?php if($route_name == "catalog" || $route_name == "index" || $route_name == "shops" || $route_name == "shop"){ ?>
                  <div class="container-search-goods-flex" >
                      <div class="container-search-goods" >
                          <form class="form-ajax-live-search" method="get" <?php if($route_name != "shops" && $route_name != "shop"){ ?> action="<?php echo $_SESSION["geo"]["alias"] ? _link($_SESSION["geo"]["alias"]) : _link($settings["country_default"]); ?>" <?php } ?> >
