       ...
       <nav aria-label="breadcrumb">
          ...
          <div class="row" >
              <div class="col-lg-12 min-height-600" >
               ...
               <?php
               $outParent = outParentExtra($getCategoryBoard, [ "tpl_parent" => '<div><a {ACTIVE} href="{PARENT_LINK}"><div class="catalog-subcategory-image" >{PARENT_IMAGE}</div><div class="catalog-subcategory-name" ><span>{PARENT_NAME} <span class="catalog-subcategory-count-ad" >{COUNT_AD}</span></span></div></a></div>', "tpl" => '{PARENT_CATEGORY}', "category" => $data["category"] ]);
               ?>
