       ...
       if($_SESSION["profile"]["id"]){
         ...
         ?>
             <div class="mobile-fixed-menu-content-card-user" >
                 <div><span class="medium-avatar-img" ><img src="<?php echo $Profile->userAvatar($_SESSION["profile"]["data"]["clients_avatar"]); ?>" /></span></div>
...
<div class="mobile-fixed-button-cart d-block d-lg-none" >
  ...
  <a <?php if($settings["marketplace_view_cart"] == 'modal'){ echo 'class="open-modal" data-id-modal="modal-cart"'; }elseif($settings["marketplace_view_cart"] == 'sidebar'){ echo 'class="sidebar-cart-open"'; }elseif($settings["marketplace_view_cart"] == 'page'){ echo 'href="'._link('cart').'"'; } ?> >
    <div>
